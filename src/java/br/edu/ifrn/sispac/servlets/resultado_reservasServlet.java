 ...
 * @author Hallessandro
 */
@WebServlet(name = "resultado_reservasServlet", urlPatterns = {"/resultado_reservasServlet"})
public class resultado_reservasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher saida = request.getRequestDispatcher("resultado_reservas.jsp");
